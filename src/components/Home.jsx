        ...
        <div>
            ...
            <section class="section-name padding-y-sm">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <Link to={"product-view"} params={{ img: "assets\images\items\young-man-in-bright-fashion.jpg" }}>

                                <div href="#" class="card card-product-grid">
                                    <a href="#" class="img-wrap"> 
                                    <img src="assets\images\items\young-man-in-bright-fashion.jpg" /> </a>
                                
                                        <h4 class="title" >SHIRTS</h4>
